 ...
 */
$config['site_title']                 = "OptiSimple";       // Site Title, example.com
...
$config['message_start_delimiter'] = '<div class="uk-badge-warning">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="uk-badge-warning" style="border-radius: 4px;">';		// Error message start delimiter
$config['error_end_delimiter']     = '</div><br>';	// Error message end delimiter
